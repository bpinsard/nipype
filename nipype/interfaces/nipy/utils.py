...
#                suffix = '_klcorr.nii') for f in self.inputs.in_files]
        ...
        outputs['distance_maps'] = [fname_presuffix(
                f, suffix='_dists.npz',newpath=os.getcwd(),use_ext=False
                ) for f in self.inputs.seed_masks]
